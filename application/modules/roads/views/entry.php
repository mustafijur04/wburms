                        ...
                        <div class="card-body">
                            ...
                            ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="text-danger">Agency *</label>
                                            <?php
                                            function sel($a, $b)
                                            {
                                            ...
                                            <select id="agency" name="agency" class="form-control dropdown" data-live-search="true">
                                                ...
                                                <option value="KMC" <?= sel($selected->agency, 'KMC') ?>>KMC</option>
                                                <option value="KMDA" <?= sel($selected->agency, 'KMDA') ?>>KMDA</option>
                                                <option value="MED" <?= sel($selected->agency, 'MED') ?>>MED</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-danger">District <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-danger">Assembly <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-danger">ULB Name <span class="text-danger">*</span></label>
                                        <select id="block_id" name="block_id" class="form-control dropdown" required <?= $disabled; ?>>
                                            <?php
                                            echo '<option value="0">--All ULB Name--</option>';
                                ...
                                <div class="col-md-6">
                                    <div class="form-group select2-input select2-warning">
                                        <label class="text-danger">Ward No<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type='text' id="borough" name="borough" class="form-control" placeholder="borough" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="road_type" name="road_type" class="form-control dropdown" data-live-search="true" required>
                                            ...
                                            <option value="Bituminious Road" <?= $selected->road_type == 'Bituminious Road' ? 'selected' : '' ?>>Bituminious Road</option>
                                            <option value="Concrete Road" <?= $selected->road_type == 'Concrete Road' ? 'selected' : '' ?>>Concrete Road</option>
                                            <option value="Bituminious/Concrete Road" <?= $selected->road_type == 'Bituminious/Concrete Road' ? 'selected' : '' ?>>Bituminious & Concrete Road</option>
                                            <option value="Paver Block" <?= $selected->road_type == 'Paver Block' ? 'selected' : '' ?>>Paver Block</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" id="pb_length_wrapper" style="display:none;">
                                    <div class="form-group">
                                        <label for="paver_length">Executable Paver Block Length (km) <span class="text-danger">*</span></label>
                                        <input type="text" id="paver_length" name="paver_length" class="form-control" placeholder="length" value="<?= $selected->paver_length ?>">
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        function toggleBtCcFields() {
            ...
            // Hide both initially
            $("#bt_length_wrapper, #cc_length_wrapper, #pb_length_wrapper").hide();
            $("#bt_length, #cc_length, #paver_length").removeAttr("required");

            if (roadType === "Bituminious Road") {
                ...
                $("#paver_length").val(0);
            } else if (roadType === "Bituminious/Concrete Road") {
                $("#bt_length_wrapper, #cc_length_wrapper").show();
                $("#bt_length, #cc_length").attr("required", true);
                $("#paver_length").val(0);
            } else if (roadType === "Paver Block") {
                $("#pb_length_wrapper").show();
                $("#paver_length").attr("required", true);
                $("#cc_length").val(0);
                $("#bt_length").val(0);
            } else {
                $("#bt_length").val(0);
        ...
        function updateExLength() {
            ...
            const pb = parseFloat($("#paver_length").val()) || 0;
            $("#ex_length").val(bt + cc + pb);
        }
        ...
        $("#bt_length, #cc_length, #paver_length").on("input", updateExLength);

        // Before form submit – make sure hidden field = 0
        $("form").on("submit", function() {

            // If BT field hidden → set BT = 0
            if ($("#bt_length_wrapper").is(":hidden")) {
                $("#bt_length").val(0);
            }

            // If CC field hidden → set CC = 0
            if ($("#cc_length_wrapper").is(":hidden")) {
                $("#cc_length").val(0);
            }

            // If PB field hidden → set PB = 0
            if ($("#pb_length_wrapper").is(":hidden")) {
                $("#paver_length").val(0);
            }
