...
define('MST_PWD', 'Pathashr33@p&rd');
...
define('SRRP_OQRC', 'srrp_oqrc');
define('SRRP_QM', 'srrp_qm');
define('SRRP_QM_INSPECTION', 'srrp_qm_inspection');
define('SRRP_QM_INSPECTION_IMAGE', 'srrp_qm_inspection_image');
define('SRRP_QM_INSPECTION_REPORT', 'srrp_qm_inspection_report');
define('SF_REPORT', 'sf_report');
define('SF', 'sf');
define('SF_SURVEY_LOG', 'sf_survey_log');
define('SF_WO', 'sf_wo');
define('SF_TENDER_LOG', 'sf_tender_log');
define('SF_NOT_IMPLEMENTED_LOG', 'sf_not_implemented');
define('SF_PROGRESS', 'sf_progress');
define('SSM_REPORT', 'ssm_report');
define('SSM', 'ssm');
define('SSM_SURVEY_LOG', 'ssm_survey_log');
define('SSM_WO', 'ssm_wo');
define('SSM_TENDER_LOG', 'ssm_tender_log');
define('SSM_NOT_IMPLEMENTED_LOG', 'ssm_not_implemented');
define('SSM_PROGRESS', 'ssm_progress');
