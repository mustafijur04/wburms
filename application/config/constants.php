...
define('MENU_PWD', 'P@ssw0rd#2025');
define('MST_PWD', 'admin');
define('DEFAULT_PWD', 'password');
define('SESSION_LOGS', 'session_logs');
...
define('AC', 'assembly_constituency');
...
define('SRRP_REPORT', 'srrp_report');
define('SRRP', 'srrp');
...
// ######### Pathashree IV (Rural Roads - 2025) ###############
define('ROADS_REPORT', 'roads_report');
define('ROADS', 'roads');
define('ROADS_SURVEY_LOG', 'roads_survey_log');
define('ROADS_WO', 'roads_wo');
define('ROADS_TENDER_LOG', 'roads_tender_log');
define('ROADS_NOT_IMPLEMENTED_LOG', 'roads_not_implemented');
define('ROADS_PROGRESS', 'roads_progress');
define('ROADS_QM', 'roads_qm');
define('ROADS_QM_INSPECTION', 'roads_qm_inspection');
define('ROADS_QM_INSPECTION_IMAGE', 'roads_qm_inspection_image');
define('ROADS_QM_INSPECTION_REPORT', 'roads_qm_inspection_report');

define('CATEGORY', 'scheme_category');
define('TYPE', 'scheme_type');
define('ROAD_TYPE', 'scheme_road_type');
define('WORK_TYPE', 'scheme_work_type');
define('AGENCY', 'scheme_agency');
define('SCHEME', 'scheme');
define('SCHEME_TENDER', 'scheme_tender');
define('SCHEME_WO', 'scheme_wo');
define('PROPOSAL', 'proposal');
define('ACTIVITY', 'scheme_activity');
define('FUND', 'scheme_fund');
##########################################################
############ COMMON ##############################
###################################################
######################## USER AUTH ######################################
...
define('WS_LOGIN', '100');
define('WS_SURVEY_LIST', '130');
define('WS_SURVEY_SUBMIT', '131');
define('WS_ROAD_NAME_LIST', '132');
define('WS_PROJECT', '110');
define('WS_SRRP_LIST', '111');
define('WS_DIVISION', '112');
define('WS_DISTRICT_LIST', '113');
define('WS_block_LIST', '114');
define('WS_GP_LIST', '115');
