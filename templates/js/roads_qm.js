...
function back_to_assignment() {
  window.location.href = baseURL + '/roads/qm/';
}

function back() {
  window.location.href = baseURL + '/roads/qm_inspection';
}
function back_qm() {
  window.location.href = baseURL + '/roads/qm_inspection_report_view/';
}

function back_to_atr() {
  window.location.href = baseURL + '/roads/qm_atr';
}
